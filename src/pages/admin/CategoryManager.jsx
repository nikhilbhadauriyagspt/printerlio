      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-6 rounded-2xl shadow-sm border border-gray-100 h-fit">
          ...
          <form onSubmit={handleAdd} className="space-y-4">
            ...
            <button className="w-full py-3 bg-black text-white rounded-xl font-bold text-sm hover:bg-blue-700 transition-all">
              Create Category
            </button>
          </form>
        </div>
                  ...
                  <div key={root.id} className="border border-gray-100 rounded-xl overflow-hidden">
                    <div className="flex items-center justify-between p-4 bg-gray-50/50">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="px-2 py-0.5 bg-blue-100 text-black text-[10px] font-bold rounded capitalize">Main</span>
                      </div>
