...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This cookie policy explains howPrintistan
        ("company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://printistan.shop/">https://printistan.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@printistan.shop">info@printistan.shop</a></li>
      ...
      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-1">
          <p className="text-slate-900">Printistan</p>
          <p>3001 27th St N, Birmingham, AL 35207, USA</p>
          <p className="pt-4 text-blue-600 font-bold">info@printistan.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
