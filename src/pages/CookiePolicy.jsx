...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This cookie policy explains howPrinting State
        ("company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://printingstate.shop/">https://printingstate.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@printingstate.shop">info@printingstate.shop</a></li>
      ...
      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-1">
          <p className="text-slate-900">Printing State</p>
          <p>Junction Plaza, Ashburn, VA 20147, USA</p>
          <p className="pt-4 text-blue-600 font-bold">info@printingstate.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
