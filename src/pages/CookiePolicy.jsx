...
export default function CookiePolicy() {
  return (
    ...
    >
      <p className="lead">
        This cookie policy explains howPrinter Lio
        ("company," "we," "us," or "our") uses cookies and similar technologies when you visit our website: <a href="https://printerlio.shop/">https://printerlio.shop/</a>
      </p>
      <p>
      ...
      <ul>
        <li>Emailing: <a href="mailto:info@printerlio.shop">info@printerlio.shop</a></li>
      ...
      <div className="bg-gray-50 p-8 rounded-xl border border-gray-100 my-8 not-prose">
        <address className="not-italic text-slate-700 font-bold leading-relaxed space-y-1">
          <p className="text-slate-900">Printer Lio</p>
          <p>9 E 36th St, New York, NY 10016, USA</p>
          <p className="pt-4 text-black font-bold">info@printerlio.shop</p>
        </address>
      </div>
    </PolicyLayout>
  );
