...
import { ShoppingCart, Heart, Plus, Zap, ChevronRight, Eye } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 gap-6">
          <div className="max-w-xl">
            ...
            <p className="text-gray-500 text-[14px] font-medium leading-relaxed">
              Explore the latest innovations in professional printing technology.
            </p>
          </div>
          <Link 
            to="/shop" 
          ...
          >
            See What's New <ChevronRight size={16} className="group-hover:translate-x-1 transition-transform" />
          </Link>
        </div>
