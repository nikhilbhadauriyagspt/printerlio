    ...
    <section className="px-6 md:px-10 lg:px-16 py-24 lg:py-32 bg-white font-urbanist overflow-hidden relative border-b border-slate-50">
      <div className="max-w-[1920px] mx-auto relative z-10">
            ...
            <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-10">
              <div className="max-w-3xl">
                <div className="flex items-center gap-2 mb-4">
                  ...
                  <span className="text-[9px] font-bold text-black uppercase tracking-[0.4em]">Quality Printer</span>
                </div>
              ...
              <div className="flex items-center gap-3 bg-slate-50 p-2 rounded-2xl border border-slate-100 shadow-sm mb-2">
                 <div className="flex gap-2">
                    <CarouselPrevious className="static translate-y-0 h-12 w-12 rounded-xl bg-white border border-slate-100 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-500 shadow-sm" />
                    <CarouselNext className="static translate-y-0 h-12 w-12 rounded-xl bg-white border border-slate-100 flex items-center justify-center hover:bg-black hover:text-white transition-all duration-500 shadow-sm" />
                 </div>
              </div>
            </div>
                  ...
                  >
                    ...
                    <div className="flex-1 flex flex-col pt-2">
                      <div className="flex items-center gap-2 mb-3">
                         <Box size={12} className="text-black" />
                         <span className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{p.brand_name || 'Authentic'}</span>
                      </div>
                      <h4 className="text-[15px] font-bold text-slate-900 uppercase er line-clamp-2 leading-tight group-hover:text-black transition-colors mb-2">{p.name}</h4>
                      
                      <div className="mt-auto flex items-center justify-between">
                         <p className="text-2xl font-bold text-slate-900 er">${p.price}</p>
                         <div className="h-12 w-12 rounded-2xl bg-white border border-slate-100 text-slate-900 flex items-center justify-center group-hover:bg-black group-hover:text-white group-hover:border-black transition-all duration-500 shadow-sm">
        ...
        <div className="mt-20 flex justify-center">
           <Link to="/shop" className="group flex items-center gap-4 text-[11px] font-bold text-slate-900 uppercase tracking-[0.3em] hover:text-black transition-colors">
              Access Complete Archive
              <div className="h-12 w-12 rounded-full border border-slate-100 flex items-center justify-center group-hover:bg-black group-hover:text-white group-hover:border-black transition-all duration-500">
                <ArrowRight size={18} />
              </div>
           </Link>
        </div>
