      ...
      <div className="w-full px-4 md:px-10 lg:px-16 max-w-[1920px] mx-auto">
        ...
        <div className="flex flex-col items-center text-center mb-12 md:mb-16">
          ...
          >
            ...
            <span className="text-[11px] font-black text-blue-600 uppercase tracking-[0.3em]">Top Trending</span>
            <span className="h-px w-8 bg-blue-600" />
          </motion.div>
          <motion.h2 
            initial={{ opacity: 0, y: 10 }}
          ...
          >
            Discover our most popular precision printers, engineered for the highest standards of reliability.
          </motion.p>
        </div>
        ...
        <div className="relative group/slider">
                    ...
                    <div className="relative aspect-[4/5] flex items-center justify-center p-8 overflow-hidden">
                      ...
                      <div className="absolute right-5 top-5 flex flex-col gap-2 translate-x-12 opacity-0 group-hover:translate-x-0 group-hover:opacity-100 transition-all duration-500">
                        <button
                          ...
                          className={cn(
                            "h-10 w-10 rounded-full bg-white shadow-xl flex items-center justify-center transition-all duration-300",
                            isInWishlist(p.id) ? "text-red-500" : "text-slate-400 hover:text-red-500"
                          )}
                        >
                          <Heart size={18} fill={isInWishlist(p.id) ? "currentColor" : "none"} />
                        </button>
                        <div className="h-10 w-10 rounded-full bg-white shadow-xl flex items-center justify-center text-slate-400 hover:text-blue-600">
                           <Eye size={18} />
                        </div>
                      </div>
          ...
          <button className="bs-prev absolute top-1/2 -left-4 md:-left-10 -translate-y-12 z-20 h-10 w-10 md:h-14 md:w-14 rounded-full bg-white shadow-2xl flex items-center justify-center text-slate-400 hover:text-blue-600 hover:bg-white transition-all border border-slate-50 opacity-0 group-hover/slider:opacity-100 active:scale-90">
            <ChevronLeft size={24} strokeWidth={3} />
          </button>
          <button className="bs-next absolute top-1/2 -right-4 md:-right-10 -translate-y-12 z-20 h-10 w-10 md:h-14 md:w-14 rounded-full bg-white shadow-2xl flex items-center justify-center text-slate-400 hover:text-blue-600 hover:bg-white transition-all border border-slate-50 opacity-0 group-hover/slider:opacity-100 active:scale-90">
