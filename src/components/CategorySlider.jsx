...
import { ShoppingCart, Heart, Plus, Zap, ChevronRight, Building2 } from "lucide-react";
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 md:mb-14 gap-6">
          <div>
            ...
            <h2 className="text-2xl md:text-4xl font-black text-slate-900 tracking-tight leading-none">
              Professional <span className="text-blue-600 italic font-medium">Printers</span>
            </h2>
            <p className="text-slate-400 text-[13px] md:text-[14px] font-medium mt-3 max-w-lg leading-relaxed">
              Industrial-grade printing solutions engineered for high-volume productivity and precision.
            </p>
          </div>
          <Link 
